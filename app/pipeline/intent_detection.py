...
_METRIC_PATTERNS: list[tuple[str, str]] = [
    ...
    (r"\bвес\w*\b|\bмасс\w+\b|\bвеш\w+\b", "weight"),
    (r"\bкалори\w+\b|\bккал\b", "calories"),
    (r"\bшаг\w*\b|\bшагомер\w*\b", "steps"),
    (r"\bрост\w*\b", "height"),
    (r"\bдистанци\w+\b|\bкилометр\w*\b|\bкм\b", "distance"),
    (r"\bвремя\b|\bдлительност\w+\b|\bпродолжительност\w+\b", "duration"),
    (r"\bтемп\w*\b|\bскорост\w+\b|\bпейс\b|\bpace\b", "pace"),
    (r"\bкаденс\b|\bcadence\b|\bшагов.в.минут\w*\b", "cadence"),
    (r"\bсон\b|\bсна\b|\bсну\b|\bсном\b|\bсне\b|\bсплю\b|\bсплюсь\b|\bнасколько.*(сплю|сон)", "sleep"),
